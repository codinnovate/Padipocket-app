       ...
       <div className='mt-[64px] flex flex-col md:flex-row md:items-center  md:justify-between w-full'>
        <div className='flex flex-col  rounded-2xl bg-[#DFF4FF]  md:flex-row w-full  justify-between md:w-[60%] px-[48px] pt-[48px] h-fit  md:h-[400px]'>
         <div className='flex flex-col gap-3'>
          <h2 className='text-primary font-semibold text-3xl'>Pay with PadiPocket, Quick, Secure and Easy</h2>
          <h3 className='text-gray font-medium'>Paying your bills  has never been easier. Whether you are paying for electricity or internet, PadiPocket gets it done within seconds.</h3>
         </div>
        ...
        <div className="w-full  md:w-[35%] h-[400px] bg-[#EAECFF] p-[36px] rounded-2xl mt-[64px] md:mt-0">
          ...
          <h3 className='text-gray mt-3'>Your money is 100% safe and secure on PadiPocket. No hassles, no glitches, get access to your money anytime.</h3>
        </div>
       </div>
    </div>
    <div className=' flex flex-col'>
     <div className='md:mt-[64px] flex flex-col md:flex-row md:items-center  md:justify-between w-full'>
      <div className="w-full  md:w-[35%] h-[400px] bg-[#FFF4E2] p-[36px] rounded-2xl ">
        ...
        <h3 className='text-gray mt-3'>PadiPocket reduced payments maintenance and processing fees. No hidden fees</h3>
      </div>
      <div className='flex flex-col mt-[64px] md:mt-0 rounded-2xl bg-[#F3F6F8]  md:flex-row w-full  justify-between md:w-[60%] px-[48px] pt-[48px] h-fit  md:h-[400px]'>
       <div className='flex flex-col gap-3'>
        ...
        <h3 className='text-gray font-medium'>Transfers, payments all work on PadiPocket. Get your alert message immediately after a completed transaction. .</h3>
       </div>
