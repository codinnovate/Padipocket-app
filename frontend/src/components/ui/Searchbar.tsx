...
const Searchbar = () => {
  return (
    <div className='flex items-center w-full   border-none px-3 py-1 max-w-[30em]' >
    ...
    className='w-full   placeholder:text-black/30 bg-inherit text-sm  font-semibold  outline-none px-2 py-1 border-none'    
    />
